package com.example.coroutinsamplekotlin
...
import com.example.coroutinsamplekotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*        CoroutineScope(newSingleThreadContext("Mohammad")).launch {
